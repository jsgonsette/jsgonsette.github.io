...
export const server_start_game: (a: number, b: number, c: number, d: number, e: number, f: bigint) => any;
...
export const closure4271_externref_shim: (a: number, b: number, c: any, d: any) => void;

...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h482caea9aeed664d: (a: number, b: number) => void;
  readonly closure173_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure4474_externref_shim: (a: number, b: number, c: any, d: any) => void;

...
function __wbg_adapter_28(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9a57516000c7f95e(arg0, arg1);
}
...
function __wbg_adapter_150(arg0, arg1, arg2, arg3) {
    wasm.closure4501_externref_shim(arg0, arg1, arg2, arg3);
}
...
export class Server {
     ...
     * @param {Uint8Array} raw_onnx_data
     */
    load_nn_model(model_name, raw_onnx_data) {
        const ptr0 = passStringToWasm0(model_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(raw_onnx_data, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.server_load_nn_model(this.__wbg_ptr, ptr0, len0, ptr1, len1);
    }
    /**
     * Called by the JS side to transmit the action selected by the human player
     * @param {number} agent_handle
     * @param {string} action_json
     */
    send_action(agent_handle, action_json) {
        const ptr0 = passStringToWasm0(action_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.server_send_action(this.__wbg_ptr, agent_handle, ptr0, len0);
    }
    /**
     ...
     */
    schedule() {
        const ret = wasm.server_schedule(this.__wbg_ptr);
        return ret;
    }
    /**
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_endofgame_c4c1e6fe45c5c265 = function(arg0, arg1) {
        let deferred0_0;
        let deferred0_1;
        try {
            deferred0_0 = arg0;
            deferred0_1 = arg1;
            end_of_game(getStringFromWasm0(arg0, arg1));
        } finally {
    ...
    imports.wbg.__wbg_getcurrenttimestamp_c30cd3bdbc688e7f = function() {
    ...
    imports.wbg.__wbg_llmmessage_e46585e9a1fd36a0 = function(arg0, arg1) {
        let deferred0_0;
        let deferred0_1;
        try {
            deferred0_0 = arg0;
            deferred0_1 = arg1;
            llm_message(getStringFromWasm0(arg0, arg1));
        } finally {
            wasm.__wbindgen_free(deferred0_0, deferred0_1, 1);
        }
    };
    ...
    imports.wbg.__wbg_savelicensecontent_6552afe6133d4867 = function(arg0, arg1, arg2, arg3, arg4, arg5) {
        let deferred0_0;
        let deferred0_1;
        let deferred1_0;
        let deferred1_1;
    ...
    imports.wbg.__wbg_schedulenotification_e90869ed211a543b = function(arg0, arg1) {
        let deferred0_0;
        let deferred0_1;
        try {
            deferred0_0 = arg0;
            deferred0_1 = arg1;
            schedule_notification(getStringFromWasm0(arg0, arg1));
        } finally {
            wasm.__wbindgen_free(deferred0_0, deferred0_1, 1);
        }
    };
    ...
    imports.wbg.__wbg_validate_6eb13ed73b0c3c0b = function() {
        validate();
    };
    ...
    imports.wbg.__wbindgen_closure_wrapper506 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 170, __wbg_adapter_31);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('buddy_worker_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
